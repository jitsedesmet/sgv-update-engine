...
export function data(id: string, url?: string): string {
    return `
        <${url ?? ''}> a <http://localhost:3000/www.ldbc.eu/ldbc_socialnet/1.0/vocabulary/Post> ;
            ...
            <http://localhost:3000/www.ldbc.eu/ldbc_socialnet/1.0/vocabulary/content> "I want to eat an apple." ;
            <http://localhost:3000/www.ldbc.eu/ldbc_socialnet/1.0/vocabulary/creationDate> "2024-05-08T23:23:56.83Z"^^<http://www.w3.org/2001/XMLSchema#dateTime> ;
