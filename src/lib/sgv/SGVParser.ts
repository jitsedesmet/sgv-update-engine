import type {ParsedSGV} from './treeStructure/ParsedSGV';
...
import {CollectionType, type RootedCanonicalCollection} from './treeStructure/StructuredCollection';
...
export class SGVParser {
    ...
    private parseCanonicalCollection(container: RDF.NamedNode): RootedCanonicalCollection {
        this.sgvStore.getQuads(container, saveConditionPredicate);
        return {
